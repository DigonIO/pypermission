...
def test_policy__empty_role() -> None:
    ...
    assert ERR_STR_CHARS.empty_role == err.value.message
...
def test_add_hierarchy__empty_parent_role(*, db: Session) -> None:
    ...
    assert ERR_STR_CHARS.empty_parent_role == err.value.message
...
def test_add_hierarchy__empty_child_role(*, db: Session) -> None:
    ...
    assert ERR_STR_CHARS.empty_child_role == err.value.message
